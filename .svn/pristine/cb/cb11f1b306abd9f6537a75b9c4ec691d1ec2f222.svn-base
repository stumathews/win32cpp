                   ...
                   int nCmdShow)
{
	...
	// We're going to show to call a COM object my using a class to isoalte some COM functionality.
	...
	if( lstrcmpiW( pszFilePath,L"") != 0 ){
		...
		// pszFilePath variable by the call to OpenFileDialog. Basically if a come object adds memory on the head, we need to
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
        ...
        break;
	case WM_MOUSEWHEEL:
		MessageBox(hWnd,L"You used the mouse wheel",L"Caption goes here",NULL);
		break;
    case WM_DESTROY:
        PostQuitMessage(0);
        break;
